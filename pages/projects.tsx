      ...
      <Row>
        ...
        <Col lg="6" md="6">
          <Card className={`${classes.project__body}`}>
            <CardBody>
              <p>
                In market, there are many Gold assaying machines available. The
                problem is that they come with a default report printing
              ...
              <p>
                ...
                reduce paper work and the efforts required to keep large record
                books.
              </p>
              <p>
        ...
        <Col lg="12" md="12">
          <Card className={`${classes.project__body}`}>
            <CardBody>
              ...
              <p>
                The requirement for food is a preoccupation on that human share
                with all other species, it is one of the worries that lie at the
                centre of all the presence. The project will grow new creative
                displaying instruments that join nourishment quality and
                prediction time to consume food products like milk, meat, fish,
                etc. For this purpose, a machine learning algorithm is used with
                hardware support of RaspberryPi embedded with temperature sensor
                which will detect room temperature with particular timespan and
                machine learning algorithm predict the lifetime of food.
              </p>
            </CardBody>
          </Card>
        </Col>
          ...
          <Card className={`${classes.project__body}`}>
            <CardBody>
              <p>
                ...
                the operations coherently and handles effectively. The objective
                of it to maintain assignment module, which assigns duties for
                faculty and handles deform module- keeps track on the number of
                students absent for a particular exam. This system keeps track
                of all records of faculty, exams, time tables and allotment of
                invigilation duties.
                <p>
        ...
        <Col lg="12" md="12">
          <Card className={`${classes.project__body}`}>
            <CardBody>
              <p>
                This is Online Student Information Management System project
                developed using Backbone.Js and SQL server as backend. In admin
                dashboard, you can:
              </p>
              <ol>
                <li>Read student records</li>
